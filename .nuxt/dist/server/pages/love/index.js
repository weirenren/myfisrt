...
/* harmony default export */ var lovevue_type_script_lang_js_ = ({
  components: {
    Carousel: () => Promise.resolve(/* import() */).then(__webpack_require__.t.bind(null, 37, 7)).then(m => m.Carousel).catch(),
    Slide: () => Promise.resolve(/* import() */).then(__webpack_require__.t.bind(null, 37, 7)).then(m => m.Slide).catch(),
