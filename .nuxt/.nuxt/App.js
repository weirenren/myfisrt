...
const _77430317 = () => import('../layouts/empty.vue'  /* webpackChunkName: "layouts/empty" */).then(m => sanitizeComponent(m.default || m))
const _5ef9cff1 = () => import('../layouts/no-footer.vue'  /* webpackChunkName: "layouts/no-footer" */).then(m => sanitizeComponent(m.default || m))

let resolvedLayouts = {}
const layouts = { "_admin": _77068119,"_default": _6f6c098b,"_empty": _77430317,"_no-footer": _5ef9cff1 }
